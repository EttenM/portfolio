  ...
  return (
    ...
    >
      <div className="w-[95%] sm:w-[90%] flex flex-col justify-center items-center gap-[20px] md:gap-[60px]">
        ...
        <div className="w-[90%] lg:w-[80%] flex flex-col lg:flex-row items-center gap-[20px] sm:gap-[2.5vw]">
          ...
          <div className="flex flex-col gap-[15px] md:gap-[30px] shrink-1">
            <p
              className="about_text split_type text-[max(16px,calc(var(--index)*2))]  lg:text-[1.6vw] hyphens-auto"
              ref={target}
              id="target"
            >
            ...
            <div className="benefit__wrap flex gap-[15px] text-[3vw] sm:text-[1.5vw] overflow-hidden">
              {text.map((item, index) => (
                <span
                  key={index}
